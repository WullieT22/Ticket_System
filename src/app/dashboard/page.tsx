          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={async () => {
                ...
                doc.text(dateRangeText, pageWidth / 2, 27, { align: 'center' })
                
                // Report details
                doc.setFontSize(8)
                doc.setFont('helvetica', 'normal')
                doc.text(`Report Generated: ${new Date().toLocaleString()}`, pageWidth / 2, 33, { align: 'center' })
                doc.text(`Generated By: ${user?.name || user?.email} | Department: ${user?.department || 'All Departments'}`, pageWidth / 2, 38, { align: 'center' })
