          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={async () => {
                ...
                // Header with gradient effect (using rectangles) - increased height
                ...
                doc.text(dateRangeText, pageWidth / 2, 24, { align: 'center' })
                
                // Report details
                doc.setFontSize(9)
                doc.setFont('helvetica', 'normal')
                doc.text(`Report Generated: ${new Date().toLocaleString()}`, pageWidth / 2, 31, { align: 'center' })
                doc.text(`Generated By: ${user?.name || user?.email} | Department: ${user?.department || 'All Departments'}`, pageWidth / 2, 37, { align: 'center' })
